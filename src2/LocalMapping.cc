...
#endif
//            cout << " LocalMapping bug 1 " << endl;
            // BoW conversion and insertion in Map
            // Step 2 处理列表中的关键帧，包括计算BoW、更新观测、描述子、共视图，插入到地图等
            ProcessNewKeyFrame();
//            cout << " LocalMapping bug 2 " << endl;
#ifdef REGISTER_TIMES
...
//            cout << " LocalMapping bug 3 " << endl;
            MapPointCulling();
//            cout << " LocalMapping bug 4 " << endl;
#ifdef REGISTER_TIMES
...
//            cout << " LocalMapping bug 5 " << endl;
            CreateNewMapPoints();
//            cout << " LocalMapping bug 6 " << endl;
...
//    cout << " 通过相邻关键帧三角化新生成的地图点个数：   " << countStereo << endl;
}
