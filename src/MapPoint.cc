...
//    cout << " AddObservation bug 1 "<< endl;
...
//    cout << " AddObservation bug 2 "<< endl;
...
//    cout << " AddObservation bug 3 "<< endl;
    // 如果没有添加过观测，记录下能观测到该MapPoint的KF和该MapPoint在KF中的索引
    mObservations[pKF]=indexes;
//    cout << " AddObservation bug 4 "<< endl;
//    cout << " AddObservation  pKF->mvuRight[idx]  "<<pKF->mvuRight[idx]  <<  endl;
    if(!pKF->mpCamera2 && pKF->mvuRight[idx]>=0)
        nObs+=2;
    else
        nObs++;
//    cout << " AddObservation bug 5 "<< endl;
}
// 删除某个关键帧对当前地图点的观测
